...
`hello-go-deploy-aks` _will test, build, push (to DockerHub) and deploy
...
It will be listed as `jeffdecola/hello-go-deploy-aks`

You can test your dockerhub image,

```bash
docker run jeffdecola/hello-go-deploy-aks
```
